...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      className={cn(
        "size-6 rounded-[calc(var(--radius)-3px)] p-0 opacity-60 hover:opacity-100 disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      {...props}
    >
      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <ComboboxPrimitive.Trigger
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden size-6 rounded-[calc(var(--radius)-3px)] p-0 opacity-60 hover:opacity-100 disabled:pointer-events-none disabled:opacity-50"
            disabled={disabled}
          >
