...
export const UserProfileForm = ({
  ...
  return (
    <form className="form-control relative w-full text-neutral-800" action={updateProfile}>
      ...
      <div className="grid grid-cols-1 gap-4 p-2">
        <div className="grid w-full grid-cols-1 gap-4 md:gap-8">
          <label className="form-control w-full">
            ...
            <select id="units" name="units" className="select select-bordered w-full" defaultValue={user?.preferences?.units ?? ""}>
