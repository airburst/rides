...
- Updated dependencies, including NextJS to address vulnerability in React Server Components
...
- Update theme and styling to work with TailwindCSS v4 and DaisyUI v5
